...
const redirectToURLWithModalState = (props, modalStateParam) => {
  ...
  navigate(
    {
      pathname,
      search: createSearchParams({ [modalStateParam]: 'open', ...parse(search) }).toString(),
    },
    {
      state,
    }
...
class TopbarComponent extends Component {
  ...
  handleSubmit(values) {
    ...
    const { navigate, config, routeConfiguration } = this.props;
  ...
  handleLogout() {
    const { onLogout, navigate, routeConfiguration } = this.props;
    onLogout().then(() => {
