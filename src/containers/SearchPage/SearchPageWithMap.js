...
export class SearchPageComponent extends Component {
  ...
  onMapMoveEnd(viewportBoundsChanged, data) {
    ...
    if (viewportBoundsChanged && isSearchPage) {
      const { navigate, location, config } = this.props;
      ...
      navigate(createResourceLocatorString('SearchPage', routes, {}, searchParams));
    }
  }
  ...
  applyFilters() {
    const { navigate, routeConfiguration, config } = this.props;
    const { listingFields: listingFieldsConfig } = config?.listing || {};
    ...
    navigate(createResourceLocatorString('SearchPage', routeConfiguration, {}, search));
  }
  ...
  handleSortBy(urlParam, values) {
    const { navigate, routeConfiguration } = this.props;
    const urlQueryParams = validUrlQueryParamsFromProps(this.props);
