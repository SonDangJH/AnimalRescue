...
const BookingTimeForm = lazy(() => import('./BookingTimeForm/BookingTimeForm'));
const BookingDatesForm = lazy(() => import('./BookingDatesForm/BookingDatesForm'));
const InquiryWithoutPaymentForm = lazy(
  () => import('./InquiryWithoutPaymentForm/InquiryWithoutPaymentForm')
);
const ProductOrderForm = lazy(() => import('./ProductOrderForm/ProductOrderForm'));
